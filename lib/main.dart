...
import 'package:registration/pages/addAssociate.dart';
import 'package:registration/pages/associateList.dart';
    ...
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.done) {
                    if (snapshot.error != null) {
                      ...
                      return Scaffold(
                        body: Center(
                          child: Text('Error initialising hive data store'),
                        ),
                      );
                    } else {
          ...
          "/AddAssociatePage": (context) => AddAssociate(),
        },
      ),
    );
  }
